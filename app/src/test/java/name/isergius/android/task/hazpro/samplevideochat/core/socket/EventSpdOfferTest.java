...
public class EventSpdOfferTest {
    ...
    public void call() throws Exception {
        ...
        eventSpdOffer.call(arg);
        Mockito.verify(messageConsumer).clientSDescription(expectedClientId, expectedSDescription);
    }
